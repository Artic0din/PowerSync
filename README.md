...
| **Architecture Refactor** | Strangler-fig rewrite toward typed `EntryRuntime`, `BatteryPort`, capability matrix, modular config/HTTP, and a single EV loadpoint arbiter | [Details](docs/wiki/Architecture-Refactor.md) |
