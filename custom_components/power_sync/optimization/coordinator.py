...
from .tariff_windows import TariffWindowsMixin
from .price_forecast import PriceForecastMixin
from .reserve_policy import ReservePolicyMixin
...
class OptimizationCoordinator(OverlaysMixin, TariffWindowsMixin, PriceForecastMixin, ReservePolicyMixin, ActionExecutorMixin, DataUpdateCoordinator[dict[str, Any]]):
    """
    ...
    def _supports_target_export_power(self) -> bool:
        ...
        try:
            ...
            if get_brand_capabilities(self.battery_system).supports_target_export_power:
                return True
    ...
    def _supports_target_charge_power(self) -> bool:
        ...
        try:
            from ..capabilities import get_brand_capabilities
            if get_brand_capabilities(self.battery_system).supports_target_charge_power:
                return True
